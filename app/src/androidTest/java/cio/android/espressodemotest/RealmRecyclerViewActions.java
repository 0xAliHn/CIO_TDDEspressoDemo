...
/**
 * {@link ViewAction}s to interact {@link RecyclerView}. RealmRecyclerView works differently than
 ...
 * {@link RecyclerView} is managed internally in {@link RecyclerView}
 * <p/>
 * <p>
...
public final class RealmRecyclerViewActions {
    ...
    private static final class ActionOnItemViewAction<VH extends ViewHolder> implements
        ...
        public void perform(UiController uiController, View root) {
            RecyclerView realmRecyclerView = (RecyclerView) root;
            RecyclerView recyclerView = (RecyclerView) realmRecyclerView.findViewById(R.id.main_task_list);
            try {
    ...
    private static final class ActionOnItemAtPositionViewAction<VH extends ViewHolder> implements
        ...
        public void perform(UiController uiController, View view) {
            RecyclerView realmRecyclerView = (RecyclerView) view;
            RecyclerView recyclerView = (RecyclerView) realmRecyclerView.findViewById(R.id.main_task_list);
    ...
    private static final class ScrollToViewAction<VH extends ViewHolder> implements
        ...
        @Override
        public void perform(UiController uiController, View view) {
            RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.main_task_list);
            try {
